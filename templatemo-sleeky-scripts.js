...
initializeImages() {
    // 💡 Correction : Initialiser toutes les faces du cube avec la première image
    this.setFaceImage(1, this.images[0].url);
    this.setFaceImage(2, this.images[0].url); 
    this.setFaceImage(3, this.images[0].url);
    this.setFaceImage(4, this.images[0].url); 
